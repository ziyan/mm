...
mm archive sync ~/mattermost-archive --only general-chat   # just the channels whose name matches
...
mm archive sync ~/mattermost-archive --exclude noisy- # skip some channels, just this once

mm archive exclude ~/mattermost-archive           # what a sync leaves alone
mm archive exclude ~/mattermost-archive noisy-alerts   # and stop reading this one
